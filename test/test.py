...
class TestKMPSearch(unittest.TestCase):
    ...
    def test_multiple_occurrences(self):
        self.assertEqual(kmp_search("лілі", "лілілось лілілось"), [(0, 3), (10, 13)])

    def test_single_occurrence(self):
        self.assertEqual(kmp_search("ліліло", "лілілось лілілось"), [(0, 5)])
    ...
    def test_partial_match_only(self):
        self.assertEqual(kmp_search("лох", "лілілохсь лілілохсь"), [(4, 6), (15, 17)])
